						...
						<c:forEach items="${products}" var="productItem">
							<tr
								...
								<td
									...
									<button type="button"
										onClick="setFormToUpdateProduct('${productItem.id}', '${productItem.title}', '${productItem.description}', '${productItem.salePrice}', '${productItem.regularPrice}', '${productItem.images[0]}','Update product ${productItem.title} in database')"
								...
								<td
									...
									<button type="button" data-modal-toggle="delete-modal"
										onClick="setIdToDeleteItem('${productItem.id}')"
										class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-800 dark:hover:text-white">

<%@ page import="me.ahmedbargady.jinafood.model.Order" %>
					...
					<tbody>
						<c:forEach items="${orders}" var="orderItem">
							<tr
                                ...
                                ${orderItem.getIsDelievred() == "true" ? "<span class='text-green-500'>Delivered<span>":"<span class='text-red-500'>Not Delivered<span>"}</span>
								...
								<%-- <td
									...
									<button type="button"
										onClick="setFormToUpdateTable('${orderItem.id}', '${orderItem.number}', '${orderItem.size}', '${orderItem.stage}', '${orderItem.isEmpty}','Update table ${orderItem.number} in database')"
								...
								<td
									...
									<button type="button" data-modal-toggle="delete-modal"
										onClick="setIdToDeleteItem('${orderItem.id}')"
										class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-800 dark:hover:text-white">

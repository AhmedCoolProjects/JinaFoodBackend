...
import me.ahmedbargady.jinafood.messages.FileUploadResponse;
import me.ahmedbargady.jinafood.model.FileInfo;
...
public class FilesController {
    ...
    public ResponseEntity<List<FileInfo>> getListFiles() {
        List<FileInfo> fileInfos = storageService.loadAll().map(path -> {
            ...
            return new FileInfo(filename, url, LocalDate.now());
